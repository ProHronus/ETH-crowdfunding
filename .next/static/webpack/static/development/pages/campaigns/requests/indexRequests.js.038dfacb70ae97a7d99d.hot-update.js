...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestRow, [{
    ...
    value: function componentDidMount() {//web3 = await web3JS.web3Init();
      //const accounts = await web3.eth.getAccounts();
    }
  }, {
    key: "FinalizerValidator",
    value: function FinalizerValidator() {
      if (this.props.btnDisabled) if (!this.props.request.complete) {
    ...
    value: function ApprovedValidator() {
      ...
      //const accounts = await web3.eth.getAccounts();
      //const isApproved = this.props.request.approvalsThisRequest(accounts[0]);
...
//# sourceMappingURL=indexRequests.js.038dfacb70ae97a7d99d.hot-update.js.map